      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <div
          className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start
                        md:max-w-none max-w-3xl mx-auto md:mx-0 md:flex-1 md:w-1/2"
        >
        ...
        <div className="flex flex-2 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
          <img
            src="https://images.pexels.com/photos/7773731/pexels-photo-7773731.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            alt="Hero image"
            width={2350}
            height={2359}
            className=" md:w-full md:h-full rounded-3xl object-cover md:max-h-non max-h-96"
          />
        </div>
      </Container>
      <Numbers />
